...
| [Crosspose.Dekompose.Cli](crosspose.dekompose.core/README.md) | CLI | Entry point for Dekompose |
...
| [Crosspose.Doctor.Cli](crosspose.doctor.core/README.md) | CLI | `--fix` attempts automated remediation |
